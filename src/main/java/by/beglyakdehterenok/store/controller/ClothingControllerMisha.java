...
public class ClothingControllerMisha {
    ...
    @Autowired
    public ClothingControllerMisha(ClothingService clothingService, CategoryService categoryService, BrandService brandService) {
